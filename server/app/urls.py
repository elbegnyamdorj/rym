...
urlpatterns = [
    ...
    path("rating-criteria/", RC.as_view(), name="create_rating"),
    ...
    path("group-more/", GroupMore.as_view(), name="create_group"),
    ...
    path(
        "subgroup/teammembers/scores/", GroupRatings.as_view(), name="get_teammembers"
    ),
